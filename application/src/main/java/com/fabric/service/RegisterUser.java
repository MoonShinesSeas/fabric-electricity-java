...
public class RegisterUser {
	...
	public String register(String name) throws Exception {
		...
		X509Identity adminIdentity = (X509Identity)wallet.get("tb-ca-admin");
		...
		Identity user = Identities.newX509Identity("TaobaoMSP", adminIdentity.getCertificate(), adminIdentity.getPrivateKey());
